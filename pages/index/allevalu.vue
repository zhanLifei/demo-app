<template>
	<view class="content">
		<view class="header">
			<view class="left_" @click="jump('/pages/index/storeinfo')">
				...
				<view class="eval_box" v-for="(it , i) in evallis" :key="i">
					...
					<view class="eval_header">
						<view class="eval_headimg">
							<image :src="it.user.avatar" mode="widthFix"></image>
						</view>
						<view class="eval_name">
							<view class="name_top">
								<view class="name_left">
									<text style="color: #333333; font-size: 30upx; font-weight: bold;">{{it.user.nickname}}</text>
								</view>
							...
							<view class="time_bottom">
								<text style="color: #999999; font-size: 24upx;">{{it.create_time}}</text>
							</view>
						</view>
					</view>
