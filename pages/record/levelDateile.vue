<template>
	<view class="content">
		<headers :Htitle="Htitle" :Hlicon="Hlicon" :url_le="url_le"></headers>
		<view class="back_blue"></view>
		<view class="back_blue22"></view>
		<view class="top_box">
			<!-- <view class="box_img">
				<image src="../../static/icon/chebei.png" mode=""></image>
			</view> -->
			<view class="box_text">
				...
				<view class="defail_it" v-for="(it , i) in scrlist" :key="it.id">
					<view class="it_left">
						<view class="left_name">
							<text style="color: #333333;font-size: 26upx;font-weight: bold;">{{it.remarks}}</text>
						</view>
						<view class="left_time">
							<text style="color:#999999;font-size: 22upx;">{{it.createtime}}</text>
						</view>
					</view>
					<view class="defail_right">
						<!-- <text>+</text> -->
						<text>{{it.contribution}}</text>
					</view>
				</view>
		...
		methods: {
			Loadthepage() {
				...
				if (self.page < self.pages) {
					...
					service.auth(self, service.api.record.getContributionlog, "GET", {
						page: page,
						limit: 15
					}, function(self, res) {
						console.log(res)
						...
						self.page = page;
						self.contribution = res.data.contribution;
