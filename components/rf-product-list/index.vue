					...
					<view class="rf-pro-content">
						...
						<view v-if="item">
							<view class="rf-pro-price">
								<text class="rf-sale-price" :class="'text-'+$mStore.getters.themeColor.name">{{ moneySymbol }}{{ item.price }}</text>
								<text class="rf-factory-price" v-if="item.market_price > item.price">{{ moneySymbol }}{{ item.market_price }}</text>
							</view>
							<view class="rf-pro-pay">
								<text
									><text :class="'text-'+$mStore.getters.themeColor.name">{{
								...
								<text
									...
									:class="'text-'+$mStore.getters.themeColor.name"
								></text>
							</view>
						</view>
					</view>
