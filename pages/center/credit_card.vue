<template>
	<view class="content">
		...
		<view class="getpos_box" v-for="(item,index) in data" :key="index" @click="navUrl(item.url)">
...
<script>
	...
	export default {
		...
		onLoad() {
			service.auth(this , service.api.center.financialCard , 'GET' , {} , function(self ,res){
				console.log(res);
