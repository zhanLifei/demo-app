<template>
	<view class="content">
		<view class="header">
			<view class="left_" @click="jump()"><image src="../../static/icon/left_whitch.png" mode=""></image></view>
			<view class="center_title"><text>汽车资讯详情</text></view>
		</view>
	...
	onShow(){
	  ...
	  onLoad(op){
				...
				console.log(this.id,this.type);
					...
					service.auth(this , service.api.index.cararticleDetail , 'GET' , {
						id:op.id,
						limit:2,
						// type:op.type
					} , function(self , res){
