	...
	<view class="content">
		...
		<view class="uploadimg">
		   <view class="uploadimg_it" v-for="(it , i) in uploadimg" :key = "it.id" >
			...
			<view class=""  v-if="it.operate != true">
		   	<view class="uploadimg_image" >
		   		<image src="../../static/icon/addimg.png" @click="upload(i)" mode=""></image>
		   	</view>
			<view class="uploadimg_name">
				<text style="color: red;">{{it.inport}}</text>
				<text>{{it.name}}</text>
			</view>
		   </view>
		   <view class="uploadimging"  v-else>
		   	<image :src="it.certi" mode="widthFix"></image>
			<view class="close" @click="closeimg(i)">
